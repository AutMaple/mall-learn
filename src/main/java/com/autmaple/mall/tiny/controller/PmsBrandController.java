...
@Tag(description = "PmsBrandController", name = "商品品牌管理")
@RestController
...
public class PmsBrandController {
    ...
    @Operation(summary="根据 id 更新对应品牌的信息")
    ...
    @Operation(summary="删除指定 id 对应的品牌信息")
    ...
    @Operation(summary="获取指定 id 对应品牌的详细信息")
    @GetMapping("/{id}")
